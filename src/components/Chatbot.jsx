      ...
      <div className="w-[200px] shrink-0 bg-[#080808] border-r border-[#1A1A1A]">
        ...
        >
          ...
          <div className="px-5 pt-6 pb-5 border-b border-[#1A1A1A]">
            ...
            <p className="text-[#4B5563] text-[11px] mb-3">Full-Stack · UI/UX · 2024</p>
            <div className="flex gap-1.5 flex-wrap">
              <span className="text-[10px] px-2 py-1 border" style={{ color: ACCENT, borderColor: ACCENT + '44', background: '#020d14' }}>
                React
              </span>
              <span className="text-[10px] px-2 py-1 border" style={{ color: ACCENT, borderColor: ACCENT + '44', background: '#020d14' }}>
                Node.js
          ...
          <div className="px-5 pt-4 pb-6 border-t border-[#1A1A1A] space-y-3">
            <div className="space-y-2">
              <div>
                ...
                <p className="text-[11px] text-[#9CA3AF]">UI/UX Designer & Full-Stack Dev</p>
              </div>
              <div>
                <p className="text-[9px] uppercase tracking-widest text-[#2A2A2A] mb-0.5">Stack</p>
                <p className="text-[11px] text-[#9CA3AF]">React · Node · OpenAI</p>
              </div>
            </div>
            <a
            ...
            <button
              disabled
              className="flex items-center justify-center gap-2 w-full py-2 text-[11px] font-bold border border-[#1A1A1A] text-[#333] cursor-not-allowed"
              title="Coming soon"
            >
      ...
      <main className="flex-1 min-w-0">
        <div className="max-w-[720px] mx-auto px-8 py-12 pb-24">
          ...
          <section id="overview" className="mb-20">
            ...
            <div className="bg-gray-200 overflow-hidden border border-[#1A1A1A] mb-8 rounded-lg">
              <div className='p-2'>
          ...
          <section id="design" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] uppercase mb-3" style={{ color: ACCENT }}>02 — Design & UX</p>
          ...
          <section id="architecture" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] uppercase mb-3" style={{ color: ACCENT }}>03 — Architecture</p>
              ...
              {STACK.map(({ layer, items }) => (
                <div key={layer} className="bg-[#0D0D0D] border border-[#1A1A1A] rounded-xl overflow-hidden">
                  <div className="px-5 py-3 border-b border-[#1A1A1A] flex items-center gap-3">
                    <span className="font-mono text-[11px] font-bold" style={{ color: ACCENT }}>/{layer.toLowerCase()}</span>
                    <span className="text-[10px] text-[#374151] font-bold uppercase tracking-wider">{layer}</span>
                  </div>
                  <div className="px-5 py-4 flex flex-wrap gap-2">
                    {items.map(item => (
                      <span key={item} className="text-[11px] bg-[#111] border border-[#222] px-3 py-1.5 text-[#9CA3AF] rounded">
                        {item}
                      </span>
                    ))}
                  </div>
          ...
          <section id="bots" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] uppercase mb-3" style={{ color: ACCENT }}>04 — The Two Bots</p>
              ...
              {BOT_COMPARISON.map(({ name, tag, color, desc, points }) => (
                <div key={name} className="bg-[#111] rounded-xl border border-[#222] overflow-hidden">
                  <div className="px-5 py-4 border-b border-[#1A1A1A]">
                    <span className="text-[10px] font-bold px-2 py-1 rounded font-mono" style={{ color, background: color + '18' }}>
                      {tag}
                    </span>
                    <p className="text-white font-bold text-sm mt-3">{name}</p>
                  </div>
                  <div className="px-5 py-4">
                    <p className="text-[#6B7280] text-xs leading-relaxed mb-4">{desc}</p>
                    <ul className="space-y-2">
                      {points.map(pt => (
                        <li key={pt} className="flex items-start gap-2 text-[11px] text-[#9CA3AF]">
          ...
          <section id="reflection" className="mb-8">
            ...
            <div className="rounded-xl p-8 border mb-12" style={{ borderColor: ACCENT + '33', background: '#020d14' }}>
              <p className="text-[11px] font-mono tracking-[0.2em] uppercase mb-2" style={{ color: ACCENT }}>Try It</p>
