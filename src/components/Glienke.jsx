      ...
      <div className="w-[200px] shrink-0 bg-[#080808] border-r border-[#1A1A1A]">
        ...
        >
          ...
          <div className="px-5 pt-6 pb-5 border-b border-[#1A1A1A]">
            ...
            <p className="text-[#4B5563] text-[11px] mb-3">Website · Frontend Dev</p>
            <div className="flex gap-2 flex-wrap">
              <span className="text-[10px] px-2 py-1 border" style={{ color: ACCENT, borderColor: ACCENT + '44', background: '#1a0a00' }}>HTML/CSS</span>
          ...
          <div className="px-5 pt-4 pb-6 border-t border-[#1A1A1A] space-y-4">
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-[#9CA3AF]">1 month</p>
              </div>
            </div>
            <a
