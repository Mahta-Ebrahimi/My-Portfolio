        ...
        >
          ...
          <div className="px-5 pt-6 pb-5 border-b border-[#1A1A1A]">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="text-white font-semibold text-[14px] leading-tight">MatchMe</h2>
            </div>
      ...
      <main className="flex-1 min-w-0">
        <div className="max-w-[720px] mx-auto px-4 sm:px-8 py-8 sm:py-12 pb-24">
          ...
          <section id="problem" className="mb-20">
            <p className="text-[13px] font-mono tracking-[0.18em] uppercase mb-3" style={{ color: ACCENT }}>02 — The Problem &amp; Solution</p>
            <h2 className="text-[22px] sm:text-[28px] font-bold text-white mb-6 leading-snug">Finding the Right Helper Shouldn't Require Five Different Apps</h2>
            ...
            <p className="text-[13px] font-semibold uppercase tracking-[0.15em] text-[#374151] mb-3">AI Features</p>
            ...
            <p className="text-[13px] font-semibold uppercase tracking-[0.15em] text-[#374151] mb-3">Core Platform Features</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          ...
          <section id="research" className="mb-20">
            <p className="text-[13px] font-mono tracking-[0.18em] uppercase mb-3" style={{ color: ACCENT }}>03 — Research</p>
            <h2 className="text-[22px] sm:text-[28px] font-bold text-white mb-6 leading-snug">Who Needs MatchMe</h2>
            ...
            <div className="bg-[#080808] border border-[#1A1A1A] rounded-xl p-6">
              <p className="text-[13px] font-semibold uppercase tracking-[0.15em] mb-2" style={{ color: ACCENT }}>Key Design Insight</p>
          ...
          <section id="visual" className="mb-20">
            <p className="text-[13px] font-mono tracking-[0.18em] uppercase mb-3" style={{ color: ACCENT }}>04 — Design System &amp; Component Library</p>
            <h2 className="text-[22px] sm:text-[28px] font-bold text-white mb-4 leading-snug">AI-First Design Principles</h2>
            <p className="text-[#9CA3AF] leading-7 mb-8 text-lg">
            ...
            <div className="bg-[#111] rounded-xl p-6 border border-[#222]">
              <p className="text-[13px] font-semibold uppercase tracking-[0.15em] text-[#374151] mb-4">Component Library</p>
              <img
          ...
          <section id="wireframes" className="mb-20">
            <p className="text-[13px] font-mono tracking-[0.18em] uppercase mb-3" style={{ color: ACCENT }}>05 — Wireframes</p>
          ...
          <section id="hifi" className="mb-20">
            <p className="text-[13px] font-mono tracking-[0.18em] uppercase mb-3" style={{ color: ACCENT }}>05 — Hi-Fi Design</p>
            ...
            <div className="border p-8 text-center bg-[#2D0A1A]" style={{ borderColor: `${ACCENT}25` }}>
              <p className="text-[13px] font-mono tracking-[0.18em] uppercase mb-2" style={{ color: ACCENT }}>Try MatchMe in Figma</p>
          ...
          <section id="learnings" className="mb-8">
            <p className="text-[13px] font-mono tracking-[0.18em] uppercase mb-3" style={{ color: ACCENT }}>07 — Reflection</p>
