      ...
      <div className="w-[200px] shrink-0 bg-[#080808] border-r border-[#1A1A1A]">
        ...
        >
          ...
          <div className="px-5 pt-6 pb-5 border-b border-[#1A1A1A]">
            ...
            <p className="text-[#4B5563] text-[11px] mb-3">Travel Agency · UI/UX</p>
            <div className="flex gap-2">
              <span className="text-[10px] bg-[#0F1B2D] text-[#60A5FA] px-2 py-1 rounded-md border border-[#60A5FA]/20">Figma</span>
              ...
              {SECTIONS.map(({ id, num, label }) => {
                ...
                return (
                  <li key={id}>
                    ...
                    >
                      <span className={`font-mono text-[9px] shrink-0 tabular-nums ${on ? 'text-[#60A5FA]' : 'text-[#1F2D1A] group-hover:text-[#374151]'}`}>
                        {num}
                      </span>
          ...
          <div className="px-5 pt-4 pb-6 border-t border-[#1A1A1A] space-y-4">
            <div className="grid grid-cols-2 gap-x-3 gap-y-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-[#9CA3AF] leading-tight">3 months</p>
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full bg-[#60A5FA] text-[#0D1117] text-[11px] font-bold py-2 rounded-lg hover:bg-[#3B82F6] transition-colors"
              >
                <FaExternalLinkAlt style={{ fontSize: '9px' }} /> View Prototype
              </a>
              <a
                href={NovaDoc} target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full bg-[#111] text-[#9CA3AF] text-[11px] font-bold py-2 rounded-lg hover:bg-[#374151] transition-colors border border-[#374151]"
              >
      ...
      <main className="flex-1 min-w-0">
        <div className="max-w-[720px] mx-auto px-8 py-12 pb-24">
          ...
          <section id="overview" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] text-[#60A5FA] uppercase mb-3">01 — Overview</p>
          ...
          <section id="problem" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] text-[#60A5FA] uppercase mb-3">02 — The Problem &amp; Solution</p>
          ...
          <section id="research" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] text-[#60A5FA] uppercase mb-3">03 — Research</p>
              ...
              {[
                ...
                <div key={name} className="bg-[#111] rounded-xl p-6 border border-[#222]">
                  <div className="mb-5">
                    ...
                    <p className="text-[#60A5FA] text-[11px] mt-0.5">{role}</p>
                  </div>
                  <div className="mb-4">
            ...
            <div className="bg-[#080808] border border-[#1A1A1A] rounded-xl p-6">
              <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#60A5FA] mb-2">Key Design Insight</p>
          ...
          <section id="visual" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] text-[#60A5FA] uppercase mb-3">04 — Visual Direction</p>
          ...
          <section id="wireframes" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] text-[#60A5FA] uppercase mb-3">05 — Wireframes</p>
          ...
          <section id="hifi" className="mb-20">
            <p className="text-[11px] font-mono tracking-[0.2em] text-[#60A5FA] uppercase mb-3">06 — Final Design</p>
            ...
            <div className="bg-[#080808] border border-[#60A5FA]/25 rounded-xl p-8 text-center">
              <p className="text-[11px] font-mono tracking-[0.2em] text-[#60A5FA] uppercase mb-2">View in Figma</p>
              <p className="text-[#6B7280] text-sm mb-6 leading-relaxed">Interactive prototype with full booking flow</p>
              <a
                href="https://www.figma.com/proto/PEZSnKDt63mPmeIKPUEbTB/Din-m%C3%83%C2%A6gler--2-?page-id=63%3A0&node-id=420-23&starting-point-node-id=420%3A23&t=COlUHCgSLO1qCgTY-1"
                target="_blank" rel="noopener noreferrer"
          ...
          <section id="learnings" className="mb-8">
            <p className="text-[11px] font-mono tracking-[0.2em] text-[#60A5FA] uppercase mb-3">07 — Reflection</p>
